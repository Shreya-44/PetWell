...
import 'C:/Users/Shalu Khanna/pet-well/src/Pages/CSS/Profile.css';
import DogProfileImage from '../Components/Assets/Dog_profile.png';
        ...
        <div className="profile-container">
            <div className="profile">
                ...
                <div className="pet-photo">
                    <img src={DogProfileImage} alt="Pet" />
                </div>
            </div>
            <div className="form">
